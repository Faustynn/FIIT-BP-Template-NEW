...
\newtcolorbox{codebox}{
    colback=black!85,      % Dark background (85% black)
    coltext=white,         % White text
    colframe=black!85,     % Frame color
    boxsep=5pt,
    arc=4pt,
    left=6pt, right=6pt, top=6pt, bottom=6pt,
    fontupper=\ttfamily\small % Typewriter font
}
...
\begin{center}
    ...
    Go to AIS -> Portál študenta -> Záverečná práca -> Zobraziť zadanie -> Download PDF
...
Example:
OpenAI: ChatGPT-5. Assistance with document styling. 
